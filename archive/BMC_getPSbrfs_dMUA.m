...
load('newSessionParams.mat')
SinkAllocate = 'BMC';
switch SinkAllocate
    case 'BMC'
        newSessionParams.EvalSink = newSessionParams.BMC_ChanNum;
    case 'Old'
        newSessionParams.EvalSink = newSessionParams.Old_ChanNum;
end
 ...
 sink = newSessionParams.EvalSink(idxnewSessionParams);       
