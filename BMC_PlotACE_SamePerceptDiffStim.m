...
% plot sinkAvg
h = figure
    plot(postStimTM,ci.monocularPS(1,:),':','color','k','LineWidth',1); hold on
    plot(postStimTM,ci.monocularPS(2,:),':','color','k','LineWidth',1); hold on
    m = plot(postStimTM,AVG.monocularPS,'color','k','DisplayName','monocular');
    hold on
    plot(postStimTM,ci.biWsoaPS(1,:),':','color',color.biWsoa,'LineWidth',1); hold on
    plot(postStimTM,ci.biWsoaPS(2,:),':','color',color.biWsoa,'LineWidth',1); hold on
